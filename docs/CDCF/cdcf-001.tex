...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{./attachments/théorique/Pasted image 20250619132805.png}
	%\caption{DESCRIPTION.}
	\caption{}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{./attachments/support_batterie_modèle.png}
