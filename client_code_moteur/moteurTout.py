...
class Robot:
    def __init__(self):
        ...
        self.direction_index = 3  # Direction initiale (0 = haut)
    ...
    def avancer(self,presObstacle):
        ...
        while not(aFinal-5<a0 and a0<aFinal+5):
            a0,a1=lire_feedback_servos(ads)
        self.pi.set_servo_pulsewidth(self.gpioM1, 1200)
        self.pi.set_servo_pulsewidth(self.gpioM2, 1800)
        a0,a1=lire_feedback_servos(ads)
        aFinal=(a0-190)%360
        while not(aFinal-5<a0 and a0<aFinal+5):
            a0,a1=lire_feedback_servos(ads)
    ...
    def tourner(self, angle):
        ...
        if angle == 90:
            aFinal=(a0-259)%360
            mot.start_pin(self.pi, self.gpioM1, -0.25)
            mot.start_pin(self.pi, self.gpioM2, -0.25)
